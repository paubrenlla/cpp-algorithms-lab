...
inputs=("10.in.txt" "100.in.txt" "1000.in.txt" "10000.in.txt" "100000.in.txt")
outputs=("10.out.txt" "100.out.txt" "1000.out.txt" "10000.out.txt" "100000.out.txt")

# Directorio de pruebas
test_dir="tests/ejercicio7"
output_dir="tests/ejercicio7Outs"
...
for i in ${!inputs[@]}; do
    ...
    ./ejercicio7 < "$input" > "$actual_output"
