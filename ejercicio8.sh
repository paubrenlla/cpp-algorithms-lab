...
inputs=("11.in.txt" "100.in.txt" "1000.in.txt" "10000.in.txt" "100000.in.txt", "1000000.in.txt")
outputs=("11.out.txt" "100.out.txt" "1000.out.txt" "10000.out.txt" "100000.out.txt", "1000000.out.txt")
